...
//!
//! Три соглашения, которые раньше знал data-browser (то есть представление):
//! каталог, суффикс `.part` у недокачанного и сидкар `.origin`. Наружу ничего
//! из этого не выходит: в контракте библиотеки есть только имя записи.
