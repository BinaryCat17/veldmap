...
/// область — чуть больше тайла, до 513². Перевалить за 4096² она может, лишь
/// когда ближайшая копия крупнее уровня в шестнадцать раз по стороне, то есть
/// в цепочке пропущено четыре уровня: честнее отказать, чем молча прочитать
/// пол-файла.
