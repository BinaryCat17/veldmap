...
pub fn on_nav_browse(state: &mut State, _event: UiEventResponse) {
    ...
    state.global.status_message = format!("Loading /{}...", state.browse.current_path);
