...
pub fn handle_set_view(req: SetViewRequest) -> anyhow::Result<SetViewResponse> {
    with_state(|state| {
...
pub fn handle_ui_event(req: HandleUiEventRequest) -> anyhow::Result<HandleUiEventResponse> {
    with_state(|state| {
...
pub fn handle_render(req: RenderRequest) -> anyhow::Result<RenderResponse> {
    let res: anyhow::Result<()> = with_state(|state| {
