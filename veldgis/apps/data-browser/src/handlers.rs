...
pub fn handle_product_selected(_state: &mut LocalState, _prod: DataProduct) -> Command<Message> { Command::none() }
...
pub fn handle_back_to_list(_state: &mut LocalState) -> Command<Message> { Command::none() }
